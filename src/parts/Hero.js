                ...
                <div className="col-auto pr-5" style={{ width: 570 }}>
                    ...
                    <div className="row" style={{ marginTop: 80 }}>
                        ...
                        <div className="col-auto" style={{ marginRight: 35 }}>
                            ...
                            <h6 className="mt-3">
                                {formatNumber(props.data.treasures)} <span className="text-gray-500 font-weight-light"> Travelers</span>
                            </h6>
                        </div>
                        <div className="col-auto" style={{ marginRight: 35 }}>
                            <img 
                            ...
                            <h6 className="mt-3">
                                {formatNumber(props.data.cities)} <span className="text-gray-500 font-weight-light"> Travelers</span>
                            </h6>
                        </div>
                    </div>
                </div>
